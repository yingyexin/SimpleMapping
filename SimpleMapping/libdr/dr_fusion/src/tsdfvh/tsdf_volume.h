 ...
 */
        ...
        public:
            ...
            /**
             * @brief      transform old TSDF volume to new TSDF.
             *
             * @param[in]  transform  the transform matrix from old TSDF reference frame to new one
             * @param[in]  new_fusion  the TSDF volume needs to be modified
             * @param[in]  low_corner & upper_corner  modify area boundary
             */
            //void transformFusion(float4x4 const &transform, TsdfVolume* new_volume, const float3 &lower_corner, const float3 &upper_corner);
            //void transformFusion(float4x4 const &transform, const float3 &lower_corner, const float3 &upper_corner);
        ...
        protected:
            ...
            cudaStream_t int_stream_, mesh_stream_, transform_stream_;
