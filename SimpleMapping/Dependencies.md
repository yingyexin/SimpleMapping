...
Similar as ORB-SLAM3 under [GPLv3 license](https://github.com/UZ-SLAMLab/ORB_SLAM3/LICENSE), we list in this document all the pieces of code included by SimpleMapping and linked libraries which are not property of the authors. 
