...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        // GeometricCamera* camera1_oriCalib() {return originalCalib1_;} // new: for undistortion
        ...
        bool mvsDepth() {return bMvsDepth_;}

        // MvsBackend Parameters
        bool MvsFlag() {return bMvsFlag_;}
        bool SettingTsdfFusion() {return bSettingTsdfFusion_;}
        int MvsnetView() {return nMvsnetView_;}
        int MvsnetRenderStream() {return nMvsnetRenderStream_;}
        bool RuntimeEval() {return bRuntimeEval_;}
    ...
    private:
        ...
        void readMvsnetParameters(cv::FileStorage& fSettings);
        ...
        bool bMvsDepth_ = false; //visualize MVSNet depth

        /* 
         * MVSNet stuff
         */
        bool bMvsFlag_;
        bool bSettingTsdfFusion_;
        int nMvsnetView_;
        int nMvsnetRenderStream_;
        bool bRuntimeEval_;
